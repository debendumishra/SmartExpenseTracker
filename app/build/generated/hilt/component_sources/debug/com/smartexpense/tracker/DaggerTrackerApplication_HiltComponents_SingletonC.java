...
import com.smartexpense.tracker.presentation.sms_dialog.SmsExpenseDialogActivity;
import com.smartexpense.tracker.presentation.sms_dialog.SmsExpenseDialogActivity_MembersInjector;
...
public final class DaggerTrackerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends TrackerApplication_HiltComponents.ActivityC {
    ...
    @Override
    public void injectSmsExpenseDialogActivity(SmsExpenseDialogActivity smsExpenseDialogActivity) {
      injectSmsExpenseDialogActivity2(smsExpenseDialogActivity);
    }
    ...
    private SmsExpenseDialogActivity injectSmsExpenseDialogActivity2(
        SmsExpenseDialogActivity instance) {
      SmsExpenseDialogActivity_MembersInjector.injectInsertSmsExpenseUseCase(instance, singletonCImpl.insertSmsExpenseUseCase());
      SmsExpenseDialogActivity_MembersInjector.injectFusedLocationClient(instance, singletonCImpl.provideFusedLocationProviderClientProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends TrackerApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.providePaymentModeDaoProvider = DoubleCheck.provider(new SwitchingProvider<PaymentModeDao>(singletonCImpl, 8));
    }
